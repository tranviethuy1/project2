      ...
      <div class="row">
        ...
        <div class="col-5 col--5--left">
          ...
          <div class="big-back-to-home">
            <a href="{{URL::Route('employeeback',array('id' => $id, 'name' => $name))}}" class="btn btn-primary"> 
              <i class="fas fa-home"></i>
            </a>

            <a href="{{URL::Route('updateprofile',array($values['user']['id']))}}" class="btn btn-primary update"> 
