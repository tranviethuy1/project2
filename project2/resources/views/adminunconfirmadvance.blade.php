...
@section('rightcontent')
	...
	<div class ="row">
		<div class ="col-md-5"><legend class ="text-info">Displaying unpaid advances</legend></div>	
	</div>
			...
			<table class="table table-bordered table-striped">
				...
				@foreach($projects as $project)
				    <tr>
				        ...
				        <td>
				        	<a href="{{Route('seeadvance',array($project->id))}}" class="btn btn-warning" style="color:#ffffff">See advance <i class="fas fa-list"></i></a>
				        </td>
				    </tr>
				@endforeach    
			    @endif  
