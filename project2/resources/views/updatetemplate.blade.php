			...
			<form class="form-horizontal" action="{{Route('excuteupdatetemplate',array($template->id))}}" method="post" enctype="multipart/form-data">
			    ...
			    <div class="form-group">
			    	<div class="row">
				    	...
				    	<div class="col-md-4"><span class="text-danger"> Chú ý * thông tin bắt buộc</span></div>
				    </div>
				</div>
				...
				<div class="form-group">
					<div class="row">
				    	<div class="col-md-2"></div>
				    	<div class="col-md-4">
				    		<button type="submit" class="btn btn-success" onclick="return sendAlert('Chắc chắn các file có định dạng : .doc .docx .pdf .ppt .pptx .xls or .xlsx!!')"> Update template <i class="fas fa-download"></i></i></button>
